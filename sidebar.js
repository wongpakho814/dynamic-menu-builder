// setTImeout() to 1 second to make sure the menu has loaded
setTimeout(() => {
...
// Re-render level 2 menu on sidebar when switch role button is clicked
const reRenderSidebarLevel2Menu = () => {
  setTimeout(() => {
    // Open the level 2 menu if the level 1 menu is clicked
    document.querySelectorAll(".nav-list-item").forEach((item) => {
      item.addEventListener("click", (e) => {
